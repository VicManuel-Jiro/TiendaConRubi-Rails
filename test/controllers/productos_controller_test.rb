...
class ProductosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create producto" do
    assert_difference('Producto.count') do
      post productos_url, params: { producto: { categoria: @producto.categoria, codigo_barras: @producto.codigo_barras, color: @producto.color, descripcion: @producto.descripcion, descuento: @producto.descuento, existencia: @producto.existencia, nombre: @producto.nombre, precio: @producto.precio, proveedor_id: @producto.proveedor_id } }
    end
